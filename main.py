...
import os
import random
conn=py.connect(user='root',password='Pranshu@1603',host='localhost',database='store')
c=conn.cursor()
...
class application:
    def __init__(self,master,*args,**kwargs):
        ...
        ###total alabel
        self.total_l=Label(self.right,text='',font=('ariel 18 bold'),bg='light blue',fg='white')
